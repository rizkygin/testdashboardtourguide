<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
  <div class="c-sidebar-brand"><img class="c-sidebar-brand-full" src="{{url('')}}/assets/brand/coreui-base-white.svg" width="118" height="46" alt="CoreUI Logo"><img class="c-sidebar-brand-minimized" src="{{url('')}}/assets/brand/coreui-signet-white.svg" width="118" height="46" alt="CoreUI Logo"></div>
  <ul class="c-sidebar-nav">
    ...
    <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
      ...
      <ul class="c-sidebar-nav-dropdown-items">
        ...
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{route('admin.reward.reedem.index')}}"> Reward Reedems<span class="badge badge-info">NEW</span></a></li>
      </ul>
    </li>
