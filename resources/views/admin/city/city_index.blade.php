    ...
    <div class="animated fadeIn">
        <div class="card">
            <div class="card-header">
              ...
              <button type="button" class="btn btn-primary btnAdd ml-10 pull-right" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" ><i class="nav-icon icon-plus"></i> Add City</button>
            </div>
