          ...
          <table class="table table-responsive-sm table-hover table-outline mb-0">
            <thead class="thead-light">
              <tr>
                ...
                <th class="col-sm-4">Name Guide</th>
                <th class="col-md-1" style="text-align:center;">Point</th>
            ...
            <tbody>
              ...
              <tr>
                <td class="text-center">
                  <div class="c-avatar"><img src="{{asset('storage/'.$data->detail->photo)}}" onerror="this.onerror=null; this.src='{{$data->detail->photo}}'"  class="avatar img-circle img-thumbnail" alt="avatar" ><span class="c-avatar-status bg-success"></span></div>
                </td>
                <td>
                  <div>{{$data->name}}</div>
