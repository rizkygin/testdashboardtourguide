    ...
    <div class="animated fadeIn">
        <div class="card" id="navaccordion">
            <div class="card-header">
              ...
              <button type="button" aria-expanded="false" class="btn btn-primary btnAdd ml-10 pull-right" data-toggle="collapse" data-target="#collapseExample"><i class="nav-icon icon-plus"></i> Add Guide</button>
            </div>
...
<script type="text/javascript">
  ...
  // window.collpse = false;
  // $('#collapseExample').on('shown.bs.collapse', function () {
  //   if (window.collpse == false) {
  //     // $("#collapseExample").removeClass("show");
  //     $("#collapseExample").collapse('hide');
  //     console.log(window.collpse)
  //   }
  //   window.collpse = true;
  // });
  // $('#collapseExample').on('hidden.bs.collapse', function () {
  //   if (window.collpse == true) {
  //     // $("#collapseExample").removeClass("show");
  ...
  // $(document).on('click', '.fa-align-justify', function (e) {
  //     $("#collapseExample").collapse('hide');
  // });
