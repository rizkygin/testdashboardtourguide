                    ...
                    <form method="POST" action="{{ route('admin.reward.store') }}" enctype="multipart/form-data">
                       @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="text" type="text" class="form-control @error('desc') is-invalid @enderror" name="description" value="{{ old('description') }}" required autocomplete="description">
    ...
    <div class="modal-content">
      ...
      <form id="frmData" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Photo</label>
            <input id="photoEdit" type="file" class="form-control" name="photo" placeholder="Photo" required>
          </div>
          <div class="form-group">
            <label>Description</label>
            <input id="descEdit" type="text" class="form-control" name="description" placeholder="Description" required>
          </div>
        </div>
...
<script type="text/javascript">
  ...
  $(document).on('click', '.btnEdit', function(e) {
    e.preventDefault;
    var id = $(this).attr('id');
    var action = "{{route('admin.reward.index')}}/"+id;
    console.log(action);
    ...
    var photo=row.find("td:eq(3)").text();
