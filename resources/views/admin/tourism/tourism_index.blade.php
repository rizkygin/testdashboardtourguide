                ...
                <table class="table table-responsive-sm table-bordered table-striped table-sm data-table" id="user-table">
                    <thead>
                        <tr>
                          ...
                          <th style="text-align: center;" class="col-sm-3">Address</th>
                          <th style="text-align: center;">Latitude</th>
                          <th style="text-align: center;">Longitude</th>
                          <th style="text-align: center;min-width:10vw;">Photo</th>
                    ...
                    <tbody>
                      ...
                      @endphp
                        ...
                        <tr id="{{ $data->id }}"> 
                            ...
                            <td><img src="{{asset('storage/'.$data->photo)}}" style="width:100px;" onerror="this.onerror=null; this.src='{{$data->photo}}'" class="avatar img-circle img-thumbnail" alt="avatar" ></td>
