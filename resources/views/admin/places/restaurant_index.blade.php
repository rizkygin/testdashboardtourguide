...
<div class="container-fluid">
    <div class="animated fadeIn">
        ...
        <div class="card">
            <div class="card-header">
              <i class="fa fa-align-justify"></i> Restaurant Places
              <button type="button" class="btn btn-primary btnAdd ml-10 pull-right" data-toggle="collapse" data-target="#collapseExample"><i class="nav-icon icon-plus"></i> Add Restaurant</button>
            </div>
                ...
                <div class="card card-body">
                    <form method="POST" action="{{ route('admin.places.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-3 col-form-label">{{ __('Restaurant Name')}}</label>
      ...
      <form id="frmData" method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="hidden" id="category_id" name="category_id" value="3">
            <input id="nameEdit" type="text" class="form-control" name="name" placeholder="Store Name" required>
          </div>
          <div class="form-group">
            <label>Address</label>
