...
<div class="container-fluid">
    <div class="animated fadeIn">
        ...
        <div class="card">
            <div class="card-header">
              <i class="fa fa-align-justify"></i> Store Places
              <button type="button" class="btn btn-primary btnAdd ml-10 pull-right" data-toggle="collapse" data-target="#collapseExample"><i class="nav-icon icon-plus"></i> Add Store</button>
            </div>
                ...
                <div class="card card-body">
                    <form method="POST" action="{{ route('admin.places.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-3 col-form-label">{{ __('Store Name')}}</label>
